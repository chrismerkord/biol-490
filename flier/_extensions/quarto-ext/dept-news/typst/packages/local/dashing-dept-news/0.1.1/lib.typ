...
#let newsletter(
  ...
  // The style for figure captions. Either "decorative" (default) for
  // the stylized [-- caption (1) --] format, or "academic" for the
  // standard "Figure 1: caption" format.
  figure-caption-style: "decorative",
  ...
  show figure: it => block({
    ...
    if it.has("caption") {
      show figure.caption: caption => {
        set align(center)
        set text(font: "Syne")
        if figure-caption-style == "academic" {
          // Academic style: "Figure 1: caption"
          if caption.supplement != none and caption.numbering != none {
            caption.supplement
            [ ]
